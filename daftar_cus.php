...
<head>
    ...
    <title>CH - Pendaftaran Customer</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Pendaftaran Customer </a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Data Customer <a href='login.php'>(Login)</a></h3>
						
						<form role="form" action="input_cus.php" method="post">
