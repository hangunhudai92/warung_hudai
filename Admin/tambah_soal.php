						...
						<form role="form" action="input_soal.php" method="post">
							<div class="form-group">
								...
								<select class="form-control" name="jns_kategori">
									<option value="Performance">Performance (kinerja)</option>
									<option value="Durability">Durability (daya tahan)</option>
									<option value="Conformance">Conformance(kesesuaian)</option>
									<option value="Features">Features (fitur)</option>
									<option value="Reliabilty">Reliabilty (reliabilitas)</option>
									<option value="Aesthetics">Aesthetics (estetika)</option>
									<option value="Quality">Perceived quality (kualitas)</option>
								</select>
							</div>
							<div class="form-group">
