                        ...
                        <h1 class="page-header">Pilih Soal yang akan dikeluarkan</h1>
							<table class="table" id="//dataTables-example">
								...
								<tbody>
									...
									$sql ="select * from soal_fuzzy where jenis_soal = 'pelayanan'";
								...
								<tbody>
									...
									$sql ="select * from soal_fuzzy where jenis_soal = 'harga'";
									$hasil = mysqli_query($konek, $sql);
									$no=1;
									while($data = mysqli_fetch_assoc($hasil))
									{
								...
								<tbody>
									...
									$sql ="select * from soal_fuzzy where jenis_soal = 'makanan'";
									$hasil = mysqli_query($konek, $sql);
									$no=1;
									while($data = mysqli_fetch_assoc($hasil))
									{
